...
ERROR_BUTTON_DIMENSIONS = (SCREEN_WIDTH // 5, SCREEN_HEIGHT // 10)
ERROR_BUTTON_POSITION = ((SCREEN_WIDTH - ERROR_BUTTON_DIMENSIONS[0]) // 2,
                         (SCREEN_HEIGHT - ERROR_BUTTON_DIMENSIONS[1]) // 2)
...
BACKGROUND_IMAGE_PATH = 'game/assets/menu/background.jpg'
