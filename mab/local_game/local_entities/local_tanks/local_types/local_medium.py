...
from local_constants import MT_IMAGE_PATH
...
class LocalMediumTank(LocalTank, ABC):
    ...
    def shot_moves(self, target: tuple) -> tuple:
        ...
        fire_locs_around_enemy = LocalHex.possible_shots(target, LocalMediumTank.__fire_deltas)
